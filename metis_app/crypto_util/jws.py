...
class JWSCore:
    ...
    def __init__(self, alg, key, header, payload, algs=None):
        ...
        :param key: A (:class:`metis_crypto.jwk.JWK`) verification or
         a (:class:`metis_crypto.jwk.JWKSet`) that contains a key indexed by the
        ...
        :raises ValueError: if the key is not a (:class:`metis_crypto.jwk.JWK`)
...
class JWS:
    ...
    def add_signature(self, key, alg=None, protected=None, header=None):
        ...
        :param key: A (:class:`metis_crypto.jwk.JWK`) key of appropriate for
         the "alg" provided.
