...
from .common import JWSEHeaderParameter, JWSEHeaderRegistry
from .common import base64url_decode, base64url_encode
...
# These have been moved to metis_crypto.common, maintain here for backwards compat
...
class JWE:
    ...
    def decrypt(self, key):
        ...
        :param key: The (:class:`metis_crypto.jwk.JWK`) decryption key.
        :param key: A (:class:`metis_crypto.jwk.JWK`) decryption key,
         or a (:class:`metis_crypto.jwk.JWKSet`) that contains a key indexed
